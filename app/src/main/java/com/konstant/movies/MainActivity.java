...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_Email) {
            ...
            intent.putExtra(Intent.EXTRA_EMAIL, new String[] {"Paste Your Email Here"});
        ...
        if (id == R.id.share){
            ...
            i.putExtra(Intent.EXTRA_TEXT, "Download my website app here");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        //paste your Socials here.
        int id = item.getItemId();
        if (id == R.id.nav_facebook) {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://facebook.com/facebook_name")));
        } else if (id == R.id.nav_twitter) {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://twitter.com/twitter_name")));
        } else if (id == R.id.nav_linkedin) {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://linkedin.com/linkedIn_ID")));
        } else if (id == R.id.nav_insta) {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://instagram.com/insta_name")));
        } else if (id == R.id.nav_apps) {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("Link to Apps website")));
        } else if (id == R.id.nav_rate) {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("Link to PlayStore")));
        }
    ...
    private void checkConnection() {
        if (isOnline()){
            String url = "Enter your url here"; //Enter your url here
            webView.loadUrl(url);
